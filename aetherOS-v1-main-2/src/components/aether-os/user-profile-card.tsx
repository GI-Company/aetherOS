...
import { Loader2, ArrowLeft, AtSign, File } from 'lucide-react';
...
export default function UserProfileCard({ userId, onBack, onOpenFile }: UserProfileCardProps) {
    ...
    <div className="p-4 space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            {user?.uid !== userId && onOpenFile && (
                 <div>
                    <h3 className="text-sm font-semibold text-muted-foreground mb-2">Actions</h3>
                    <Button variant="outline" className="w-full" onClick={handleOpenVFS}>
