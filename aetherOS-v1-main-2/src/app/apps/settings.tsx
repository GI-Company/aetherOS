...
export default function SettingsApp({onOpenApp, defaultTab}: SettingsAppProps) {
  ...
  const handleGenerateTheme = async () => {
    ...
    resSub = aether.subscribe('ai:generate:palette:resp', handleResponse);
    errSub = aether.subscribe('ai:generate:palette:error', handleError);
  };
  ...
  const handleGenerateAccent = async () => {
    ...
    resSub = aether.subscribe('ai:generate:accent:resp', handleResponse);
    errSub = aether.subscribe('ai:generate:accent:error', handleError);
  };
